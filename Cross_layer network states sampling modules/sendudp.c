...
static int hello_init(void)
{
	...
	printk(KERN_DEBUG "Hello, kernel %u %u %u %u", sizeof(struct data_iw), sizeof(struct data_iw *), sizeof(struct dp_packet), sizeof(struct data_beacon));
